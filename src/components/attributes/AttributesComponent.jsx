...
import { incrementAttribute, decrementAttribute } from '../../reducers/attributes';
...
const AttributesComponent = () => {
	const {
		metatype: metatypeRating,
		magres: magicPriority,
		attribute: priorityRating,
	} = useSelector(state => state.priorityTable);
